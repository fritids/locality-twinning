...
if (tloc.indexOf(sc_prodURL)!= -1) s_account=sc_prodRSID;
else if (tloc.indexOf(sc_uatURL)!= -1) s_account=sc_uatRSID;	
else if (tloc.indexOf(sc_devURL)!= -1) s_account=sc_devRSID;
else s_account=sc_devRSID;
...
s.charSet = sc_charSet;
s.currencyCode = sc_currency;
s.trackDownloadLinks = true;
s.trackExternalLinks = true;
s.trackInlineStats = true;
s.linkDownloadFileTypes = "exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls";
s.linkInternalFilters = sc_internalDomain;
...
function s_doPlugins(s) {
	...
	s.prop75="s_code_v2.0 - H.24.3_20120227";
	...
	// Time Parting 
	s.prop22=s.eVar22=s.getTimeParting('h',sc_timezone); 
	s.prop23=s.eVar23=s.getTimeParting('d',sc_timezone);	
