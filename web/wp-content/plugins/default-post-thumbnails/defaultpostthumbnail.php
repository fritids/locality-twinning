...
function display_default_thumbnail($content) {
    ...
    if (!$thumbnail_id) {
	$thumbnail_html = wp_get_attachment_image( $default_thumb[defaultthumbnail], array(150,150) );
	$thumbnail_html .= "<p>This default thumbnail will be used unless you set a thumbnail for this post.</p>";
    }
