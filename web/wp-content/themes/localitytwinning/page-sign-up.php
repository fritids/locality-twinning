...
switch ($action) {
    ...
    default:
        ...
        if ( isset( $_REQUEST['redirect_to'] ) ) {
            ...
            $redirect_to = site_url('user');//admin_url();
        }
        ...
        if ( !is_wp_error($user) && !$reauth ) {
            ...
            if ( ( empty( $redirect_to ) || $redirect_to == 'wp-admin/' || $redirect_to == admin_url() ) ) {
                ...
                if ( is_multisite() && !get_active_blog_for_user($user->ID) && !is_super_admin( $user->ID ) )
                    $redirect_to = site_url( 'user', 'login_post' );//user_admin_url();
                elseif ( is_multisite() && !$user->has_cap('read') )
                    $redirect_to = site_url( 'user', 'login_post' );//get_dashboard_url( $user->ID );
                elseif ( !$user->has_cap('edit_posts') )
                    $redirect_to = site_url( 'user', 'login_post' );//admin_url('profile.php');
            }
            wp_safe_redirect($redirect_to);
            exit();
        }
        ...
        <form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'user/signup', 'login_post' ) ); ?>" method="post">
            <?php //echo get_bloginfo('url');
            //echo '<br/>';
           //echo site_url( 'user/signup', 'login_post' );
