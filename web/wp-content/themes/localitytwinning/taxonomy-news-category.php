...
$args['type'] = (isset($_GET['type']) && $_GET['type']) ? 'popular' : 'news';
$args['term'] = $term;
...
<div id="container" data-role="page"><!-- begin #topads-->
    ...
    <div id="news" class="section-container clearfix">
        ...
        <?php echo wheels_esi_include(get_template_directory_uri().'/esi/readers-thoughts.php?post_type=news')?>
        ...
        <div class="row section-row">
            ...
            <div class="pull-quote">
                ...
                <div class="pos">
                    ...
                    <a href="<?php the_permalink()?>" class="article"><?php the_title()?></a>
                    <span class="author"><?php the_author()?></span>
                </div>
