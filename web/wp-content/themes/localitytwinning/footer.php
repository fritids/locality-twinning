...
<!-- begin #bg-navprimary-menu-0-->
<div id="bg-navprimary-menu-0" data-menuitem="news-features-menu-item" class="menu main-menu-window">
    ...
    <div class="pos">
        ...
        <div class="content">
            ...
            <div class="inside">
                ...
                <?php echo wheels_esi_include(get_template_directory_uri() . '/esi/header/news-feature-category.php')?>
            ...
            <div class="headlines">
                <h5>Headlines</h5>
                <?php echo wheels_esi_include(get_template_directory_uri() . '/esi/header/news_and_feature_latest_news.php')?>
            </div>
            <!-- end .headlines-->
            ...
            <div class="features">
                <h5>Features</h5>
                <?php echo wheels_esi_include(get_template_directory_uri() . '/esi/header/news_and_feature_latest_feature.php')?>
            </div>
            <!-- end .features-->
        </div>
...
<!-- end #bg-navprimary-menu-0-->

<!-- begin #bg-navprimary-menu-1-->
<div id="bg-navprimary-menu-1" data-menuitem="vehicles-reviews-menu-item" class="menu main-menu-window">
    ...
    <div class="pos">
        ...
        <div class="content">
            ...
            <div class="inside">
                <h5>Inside</h5>
                <ul>
                    <li><a href="<?php echo site_url(); ?>/vehicles">Vehicles</a></li>
            ...
            <!-- begin .popular-->
            <div class="popular">
                <h5>Popular Vehicles</h5>
                <?php echo wheels_esi_include(get_template_directory_uri() . '/esi/header/vehicles_and_reviews_popular_vehicles.php')?>
            </div>
            <!-- end .popular-->
            ...
            <div class="features reviews">
                <h5>Features</h5>
                <?php echo wheels_esi_include(get_template_directory_uri() . '/esi/header/vehicles_and_reviews_feature.php')?>
            </div>
            <!-- end .features-->
        </div>
...
<!-- end #bg-navprimary-menu-1-->

<!-- begin #bg-navprimary-menu-2-->
<div id="bg-navprimary-menu-2" data-menuitem="guides-menu-item" class="menu main-menu-window">
    ...
    <div class="pos">
        ...
        <div class="content">
            ...
            <!-- begin .inside-->
            <div class="inside">
                <?php echo wheels_esi_include(get_template_directory_uri() . '/esi/header/guides-category.php')?>
            </div>
            <!-- end .inside-->
            ...
            <div class="headlines">
                <h5>Latest</h5>
                <?php echo wheels_esi_include(get_template_directory_uri() . '/esi/header/guides_latest.php')?>
            </div>
            <!-- end .headlines-->

            <!-- begin .experts-->
            <div class="features experts">
                <h5>Our Experts</h5>
                <?php echo wheels_esi_include(get_template_directory_uri() . '/esi/header/guides_our_experts.php')?>
            </div>
            <!-- end .experts-->
        </div>
    </div>
</div>
<!-- end #bg-navprimary-menu-2-->
