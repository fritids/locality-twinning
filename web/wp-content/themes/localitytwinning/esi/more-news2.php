...
$latestNews = $postModel->getAll(array('limit'=>4, 'custom_field' => true));
$popularNews = $postModel->getAll(array('type'=>'popular', 'limit'=>4, 'custom_field' => true));
*/
require '../../../../wp-load.php';
...
?>
<div class="module related-articles clearfix">
    <div data-controller="TabsController" class="clearfix related-news">
        <h3>News</h3>
        <div class="tab-nav">
            <ul class="clearfix">
                <li><a>Related</a></li>
