...
$popularNews = $postModel->getAll(array('post_type' => 'news', 'limit' => 9, 'type' => 'popular', 'custom_field' => true));

if(!empty($popularNews)):
    ?>
<div class="reviewCarouselContainer" style="display: none">
    <div id="newsfeaturesCarousel2" data-controller="CarouselController" class="carousel slide">
        ...
        <a href="#newsfeaturesCarousel2" data-slide="prev" class="carousel-control left">&lsaquo;</a>
        <a href="#newsfeaturesCarousel2" data-slide="next" class="carousel-control right">&rsaquo;</a>
