    ...
    <div id="news" class="section-container clearfix">
        ...
        <div class="row">
            ...
            <div class="in-this-section">
                ...
                <?php
                $latest_news = wp_cache_get('guides-taxonomy-in-this-section', 'wheels');
                if(!$latest_news){
                    $args['start'] = 9;
                    $args['limit'] = 10;
                    $latest_news = wheels_news_get($args);
                    wp_cache_add('guides-taxonomy-in-this-section', $latest_news, 'wheels');
                }
                ?>
                <ul>
                    <?php
        ...
        <?php echo wheels_esi_include(get_template_directory_uri().'/esi/readers-thoughts.php?post_type=guides')?>
